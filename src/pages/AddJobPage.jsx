import { MoveLeft, Plus, ChevronDown } from "lucide-react";
...
export const AddJobPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    title: "",
    status: "Applied",
    applicationDate: getTodayDate(), // Default to today's date
    notes: "",
  });
  ...
  return (
    <div className="w-full bg-white px-5 py-10 flex flex-col gap-6 md:px-10 lg:px-10">
      <div className="flex items-center gap-6">
        ...
        <div>
          <h2 className="text-3xl font-bold">Add Job Application</h2>  {/* Fixed typo */}
          <p className="text-gray-600">
            Enter details for your new job application
          </p>
        </div>
      </div>
      ...
      <div className="p-6 bg-gray-100 flex flex-col gap-4 justify-start rounded-xl">
        ...
        <form onSubmit={handleAddJob} className="flex flex-col gap-3">
          ...
          >
            <Plus size={20} />
            <h4 className="font-semibold">Add Job Application</h4>
          </button>
